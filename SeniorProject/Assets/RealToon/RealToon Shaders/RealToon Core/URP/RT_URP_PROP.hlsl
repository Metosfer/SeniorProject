...
#define _TriPlaTile										UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float, Metadata__TriPlaTile)
#define _TriPlaBlend									UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float, Metadata__TriPlaBlend)
